...
def transfer_file_to_remote_host(local_file_path, remote_file_path, hostname, username, private_key_path, minerId):
    """
    ...
    try:
        ...
        # Optionally, use minerId to modify the remote file path
        # Example: Append minerId to the remote file path
        # remote_file_path = f"{remote_file_path}.{minerId}"
        ...
        # print(f"File {local_file_path} transferred to {remote_file_path} on {hostname} (Miner ID: {minerId})")
...
if __name__ == "__main__":
    ...
    # transfer_file_to_remote_host(local_file_path, remote_file_path, hostname, username, private_key_path, minerId)